...
const items = [
  {
    label: <Link to='/home2'>Folder1</Link>,
    key: '0',
  },
  {
    label: <Link to='/home2'>Folder2</Link>,
    key: '1',
  },
  {
    label: 'Folder3',
...
const index = () => {
  return (
    <div className='aside__main'>
      <ul className='ul__'>
        <li>
          <NavLink to='/home' className='navlink__'>
            <svg
              viewBox='0 0 24 24'
              fill='none'
              class='dig-UIIcon dig-UIIcon--standard _navIcon_10jct_1'
              width='24'
              height='24'
              role='presentation'
              focusable='false'
        ...
        <li>
          <NavLink to='/home1' className='navlink__'>
            <svg
              viewBox='0 0 24 24'
              fill='none'
              class='dig-UIIcon dig-UIIcon--standard _navIcon_10jct_1'
        ...
        <li>
          <NavLink to='/home2' className='navlink__'>
            <svg
              viewBox='0 0 24 24'
              fill='none'
              class='dig-UIIcon dig-UIIcon--standard _navIcon_10jct_1'
        ...
        <a onClick={(e) => e.preventDefault()}>
          <Space>
            <svg
              viewBox='0 0 24 24'
              fill='none'
              class='dig-UIIcon dig-UIIcon--standard _sectionHeaderChevron_4oe73_86'
              width='15'
              height='15'
              role='presentation'
              focusable='false'
