      ...
      <div className='container'>
        <div className='home__wrapper'>
          ...
          <div className='folder__style'>
            ...
            >
              ...
              <div className='fs__about--info'>
                <p>Folder name</p>
                <span>Folder • Medify</span>
              </div>
            </div>
          </div>
        ...
        {/* <div className='uploads__'>
            <div className='drop__'>
                ...
                viewBox='0 0 64 64'
                fill='none'
                class='dig-PictogramIcon _emptyStateViewIcon_a086g_304'
                width='64'
                height='64'
                focusable='false'
                role='presentation'
            ...
            <button className='activiy__card1'>Uploads</button>
            </div> */}
      </div>
    </section>
  );
